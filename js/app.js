...
jQuery(document).ready(function () {
  ...
  var navcontent = document.getElementById("primary-menu"); //var navaction = document.getElementById("navAction");
  ...
  var navMenuDiv = document.getElementById("primary-menu");
